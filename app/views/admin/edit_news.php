...
<header class="custom-gradient text-white p-6 flex justify-between items-center">
    <div class="flex items-center">
        <a href="/admin/news-list" class="back-link flex items-center mr-4">
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <form action="/admin/edit-news?id=<?= $news['id'] ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <select name="category_id" id="category_id" required 
                            ...
                            <?php foreach ($categoriesFromDB as $category): ?>
                ...
                <div>
                    <label for="release_date" class="block text-sm font-medium text-gray-700 mb-2">Release Date & Time</label>
                    <input type="datetime-local" name="release_date" id="release_date" required 
                           value="<?= date('Y-m-d\TH:i', strtotime($news['release_date'])) ?>"
                           class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
...
<!-- Category Management Modal (Same as add_news.php) -->
...
<script>
// Same JavaScript as add_news.php
